...
async function testImports() {
  try {
    const { generateFilesFromPrompt } = await import('../src/services/gemini.js')
    assert(typeof generateFilesFromPrompt === 'function', 'generateFilesFromPrompt should be a function')
...
async function testFallbackGeneration() {
  try {
    ...
    assert(typeof result.qualityReport === 'object', 'Result should have qualityReport')
